...
switch ($kindof){
    case 1:
        ...
        $message.="Foglalását köszönettel regisztráltuk!\r\n";
        $message.="Feldolgozása után kapcsolatba lépünk önnel!\r\n";
...
}
    {
        ...
        $result=mail($email,"Elözetes Foglalás visszaigazolása",$message,$headers.'From: '.$confirmation_sender."\r\n".'Reply-To: '.$confirmation_sender);
        $result2=mail($admin_to_notify,"Új foglalás érkezett",$message,$headers.'From: '.$confirmation_sender."\r\n".'Reply-To: '.$confirmation_sender);
